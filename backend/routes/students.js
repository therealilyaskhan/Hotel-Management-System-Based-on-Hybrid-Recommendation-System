...
import { deleteStudent, getStudent, getStudents, updateStudent, signup, studentImageUpload, signin } from '../controllers/students.js';
...
router.route('/:id/image').put(studentImageUpload);
